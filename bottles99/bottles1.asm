...
e_l1:					; start of loop e_l1
	...
	add ax, 48			; ax += 48
	;--- system call ---
	sub rsp, 8			; make some space for storing ax on the stack
	mov QWORD [rsp], rax		; move ax to a memory location on the stack
...
e_l2:					; start of loop e_l2
	...
	jmp e_l2				; loop forever
e_l2_end:				; end of loop e_l2
	;--- end of loop e_l2 ---
...
l3:					; start of loop l3
	...
	jz l3_end			; jump out if the loop is done
	cmp cx, 2			; compare
	jge l3			; continue
	...
	pop rcx				; restore counter
	dec rcx				; decrease counter
	jnz l3				; loop until rcx is zero
l3_end:				; end of loop l3
	;--- end of loop l3 ---
